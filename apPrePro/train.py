...
parser.add_argument('--dataset_dir', type=str, default='/home/huangx/disk4T/xxyu/dataset/kp_ap/kp_ap', help='dir of the dataset')
...
'''
data_fname = ['train1932_2014.csv', 'test2015_2018.csv']
train_data_path = os.path.join(opt.dataset_dir, data_fname[0])
test_data_path = os.path.join(opt.dataset_dir, data_fname[1])

train_dataset = KpApF107Dataset(train_data_path, timestep = opt.time_step, predlen= opt.pred_len,datatype=opt.data_type)
test_dataset = KpApF107Dataset(test_data_path, timestep = opt.time_step, predlen= opt.pred_len,datatype=opt.data_type)
