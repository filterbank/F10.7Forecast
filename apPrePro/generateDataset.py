...
infdir = '/home/huangx/disk4T/xxyu/dataset/kp_ap/kp_ap'
outfdir = '/home/huangx/disk4T/xxyu/dataset/kp_ap/kp_ap'
'''
infdir = './kpapdata'
outfdir = './kpapdata'
'''
#fnames_list = ['train1932_2000.csv', 'test2001_2018.csv']
fnames_list = ['train1932_2014.csv', 'test2015_2018.csv']
...
filenumb = len(list_files)       #1932-2018,  1932-2014 trian, 2015-2018 test
#testnumb = 18
testnumb =4
